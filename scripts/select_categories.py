...
CONFIGS = {
    ...
    "demographic": {
        "categories": [
            1001,
            100011,
        ],  # [1001, 1002, 1006] #100011 blood pressure, 100007 arterial stiffness
        "fields": [
            4194,
            50,
            21002,
            21,
            1707,
        ],  # 4194 pulse rate, 50 standing height, 21002 weight, 21 weight method, 1707 handedness
        "title_substring": None,
        "title_substrings_reject": [
    ...
    "viprs": {
        # "categories": [108, 110, 112, 119, 106, 107, 111, 109, 200],
        "categories": [110],
        "fields": [],
        "title_substring": None,
        "title_substrings_reject": [],
...
def select_categories(
    ...
    try:
        ...
        raise ValueError(
            f'Invalid domain "{domain}". Accepted domains are: {CONFIGS.keys()}'
        )
    ...
    udis = db_helper.get_udis_from_categories_and_fields(
        categories,
        fields=fields,
        value_types=value_types,
        title_substring=title_substring,
        title_substrings_reject=title_substrings_reject,
        instances=instances,
    ...
    n_rows, n_cols = write_subset(
        fpath_data, fpath_out, colnames=udis, chunksize=chunksize
    )
